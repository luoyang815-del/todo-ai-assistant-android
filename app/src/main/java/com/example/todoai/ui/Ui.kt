package com.example.todoaiassist.ui
...
import com.example.todoaiassist.todo.TodoRepository
...
fun Ui(repo: TodoRepository, ai: OpenAIClient, modifier: Modifier = Modifier) {
    ...
    val itemsState = remember { mutableStateOf(repo.list()) }
    ...
    Column(modifier.padding(16.dp)) {
        ...
        val importantList = itemsState.value.filter { it.important }
        val normalList = itemsState.value.filter { !it.important }.take(10)
